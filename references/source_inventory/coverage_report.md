...
- SR certainty, appraisal, bias, and search QA with local evidence: GRADE, GRADE Handbook, CERQual, AMSTAR 2, ROBIS, RoB 2, ROBINS-I, and PRESS. PRESS is scoped to peer review of electronic search strategies and should not be used as whole-review conduct guidance.
...
For `sr_writing_prior`, source-card-v2 coverage now includes PRISMA 2020, PRISMA extensions, PRISMA-S, PRISMA-P, Cochrane Handbook, MECIR, JBI Manual, Campbell Standards, GRADE/CERQual, AMSTAR 2, ROBIS, RoB 2, ROBINS-I, PROSPERO, EQUATOR PRISMA, registry/API locators, and manually captured PRESS E&E evidence. Use PRESS only for electronic-search-strategy peer-review/search-QA claims.

For `survey_writing_prior`, source-card-v2 coverage now includes PRISMA-ScR, JBI Manual, Cochrane chapters 9 and 12, SWiM, ENTREQ, RAMESES, SANRA, state-of-the-art review methodology, York narrative synthesis guidance, narrative-review writing guidance, Nickerson taxonomy method, Kundisch taxonomy update, manually captured CACM/ACM venue guidance, venue/exemplar cards, and scholarly-database/API cards. Use `state_of_art_review_2022` only for scoped SotA review methodology claims and CACM/ACM pages only for venue/publisher guidance.
