...
| --- | --- | ---: | ---: | --- |
| openai_codex_agents_md | available | 1 (1/1) | 0 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/openai_codex_agents_md/canonical_agents-md.md |
| openai_codex_skills | available | 1 (1/1) | 0 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/openai_codex_skills/canonical_skills.md |

## nlp_speech_cs_exemplar_sources

| source_id | status | docs md/raw | blocked | primary md path |
| --- | --- | ---: | ---: | --- |
| acl_anthology | available | 1 (1/1) | 0 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/acl_anthology/canonical_api.md |
| acl_anthology_github | available | 1 (1/1) | 0 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/acl_anthology_github/canonical_acl-anthology.md |
...
| dimensions_api | partial | 4 (4/4) | 2 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/dimensions_api/canonical_product_api_dimensions-api.md |
| epistemonikos | available | 1 (1/1) | 0 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/epistemonikos/canonical_en.md |
| equator_prisma | available | 5 (5/5) | 0 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/equator_prisma/canonical_prisma.md |
| europe_pmc | available | 3 (3/3) | 0 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/europe_pmc/canonical_restfulwebservice.md |
| ieee_xplore_api | partial | 5 (5/5) | 1 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/ieee_xplore_api/canonical_docs_home_docs.md |
| lens_api | partial | 5 (5/5) | 1 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/lens_api/canonical_docs_home_canonical_docs_home.md |
| openalex | available | 1 (1/1) | 0 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/openalex/canonical.md |
| openalex_snapshot | partial | 5 (5/5) | 1 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/openalex_snapshot/canonical_snapshot_format_manifest_url_snapshot-format_9050c8de.md |
| opencitations | partial | 5 (5/5) | 1 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/opencitations/canonical_home_canonical_home.md |
| prospero | available | 1 (1/1) | 0 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/prospero/canonical_maintenanceprospero.html.md |
| pubmed_eutilities | available | 2 (2/2) | 0 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/pubmed_eutilities/canonical_nbk25497.md |
| scite_api | partial | 2 (2/2) | 2 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/scite_api/official_api_docs_docs_7da8d680.md |
| semantic_scholar | partial | 5 (5/5) | 1 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/semantic_scholar/canonical_product_api_api.md |
| who_ictrp | available | 2 (2/2) | 0 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/who_ictrp/canonical_the-ictrp-search-portal.md |

## sr_certainty_appraisal_bias_search

| source_id | status | docs md/raw | blocked | primary md path |
| --- | --- | ---: | ---: | --- |
| amstar2 | available | 4 (4/4) | 0 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/amstar2/canonical.md |
...
| source_id | status | docs md/raw | blocked | primary md path |
| --- | --- | ---: | ---: | --- |
| campbell_standards | available | 1 (1/1) | 0 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/campbell_standards/canonical_standards.md |
...
| ieee_comst_guidelines | partial | 3 (3/3) | 2 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/ieee_comst_guidelines/canonical_policies-guidelines.md |
| kundisch_taxonomy_update_2021 | available | 3 (3/3) | 0 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/kundisch_taxonomy_update_2021/canonical_s12599-021-00723-x.md |
| narrative_review_writing_2011 | available | 2 (2/2) | 0 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/narrative_review_writing_2011/canonical_writing-reviews.pdf.md |
| narrative_synthesis_york_2006 | available | 2 (2/2) | 0 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/narrative_synthesis_york_2006/canonical_guidance_20on_20the_20conduct_20of_20narrative_20synthesis_20in_20systematic_20r.md |
| nature_reviews_submission | available | 5 (5/5) | 0 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/nature_reviews_submission/canonical_preparing-your-submission.md |
| nature_scirev_guidelines | available | 2 (2/2) | 0 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/nature_scirev_guidelines/canonical_submission-guidelines.md |
| nickerson_taxonomy_2013 | partial | 1 (1/1) | 2 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/nickerson_taxonomy_2013/publisher_pdf_ejis.2012.26.pdf.md |
| prisma_scr | available | 5 (5/5) | 0 | docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/md/prisma_scr/canonical_scoping.md |
