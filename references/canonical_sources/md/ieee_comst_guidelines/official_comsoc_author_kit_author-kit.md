...
# IEEE ComSoc Technical Committees Newsletter Author Kit
...
Articles should be 1000-2000 words in length, including an abstract no longer than 50 words. Authors are expected to use the template provided ( [MSWord](http://www.inf.ufrgs.br/~granville/wp-content/uploads/Article-Template-V2-msword.zip) , [LaTeX](http://www.inf.ufrgs.br/~granville/wp-content/uploads/Article-Template-V2-latex.zip) ). Please make sure your opening paragraphs communicate your main message and convey why that message is relevant or important for readers to appreciate it.
...
Please address questions or submit your article, including your short-bio (around 100 words), high-resolution photo, and images/illustrations via the JEMS submission system, at [https://jems.sbc.org.br/ComSocTCsNewsletter](https://jems.sbc.org.br/ComSocTCsNewsletter) .

## Contact:

Lisandro Zambenedetti Granville, IEEE ComSoc Technical Committees Newsletter Editor-in-Chief, granville@inf.ufrgs.br
