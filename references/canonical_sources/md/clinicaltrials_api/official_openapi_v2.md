# ClinicalTrials.gov REST API OpenAPI v2

Source URL: https://clinicaltrials.gov/api/oas/v2
Captured: 2026-05-05
Local raw file: `references/canonical_sources/raw/clinicaltrials_api/official_openapi_v2.yaml`
Evidence note: official OpenAPI document for ClinicalTrials.gov API v2; use for endpoint and schema locators, not as review methodology authority.

## API Identity

- OpenAPI version: 3.0.3.
- API title: ClinicalTrials.gov REST API.
- API document version: 2.0.5.
- Base server URL: `https://clinicaltrials.gov/api/v2`.

## Endpoint Locator Summary

The OpenAPI `paths` section includes these high-value endpoint families:

- `/studies`: paginated study retrieval with query and filter parameters.
- `/studies/{nctId}`: single-study retrieval.
- `/studies/metadata`: study data model metadata.
- `/studies/search-areas`: search-area definitions.
- `/studies/enums`: enum metadata.
- `/stats/size`, `/stats/field/values`, `/stats/field/sizes`: statistics endpoints.
