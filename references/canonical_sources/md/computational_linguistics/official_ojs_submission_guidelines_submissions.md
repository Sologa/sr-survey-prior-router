# computational_linguistics (official_ojs_submission_guidelines)

Source URL: https://submissions.cljournal.org/index.php/cljournal/about/submissions
Local raw file: `docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/raw/computational_linguistics/official_ojs_submission_guidelines_submissions.html`

Submissions | Computational Linguistics
...
[Login](https://submissions.cljournal.org/index.php/cljournal/login) or [Register](https://submissions.cljournal.org/index.php/cljournal/user/register) to make a submission.

## Author Guidelines

## Submission Preparation Checklists

- For original submissions , refer to this [checklist](https://submissions.cljournal.org/index.php/cljournal/OriginalSubmissionChecklist) .
...
Since Volume 51 (March 2025), Computational Linguistics has adopted a new vision. Under its new vision, the journal strongly encourages research that engages with emerging paradigms, with particular emphasis on contemporary language model technologies (e.g., Large Language Models, or LLMs) and other transformative developments reshaping computational language research. At the same time, the journal remains committed to insightful contributions grounded in theoretical, mathematical, algorithmic, linguistic, and interdisciplinary perspectives. We particularly welcome studies that bridge these foundational principles with the latest scientific advancements. Our mission is for Computational Linguistics to serve as a central forum where diverse perspectives converge and collaborate to drive the field forward. Please refer to this [Editorial](https://direct.mit.edu/coli/article/51/1/1/127780/Opening-a-New-Chapter-for-Computational) for more information.

Manuscripts for Computational Linguistics should be submitted in a PDF file, formatted single-spaced in accordance with our [Style Guidelines](https://submissions.cljournal.org/index.php/cljournal/StyleGuide) , including an abstract. The title, authors' names, and abstract should also be provided separately in a text file, with the contact author's email address clearly indicated. Manuscripts must be written in English.
...
Long Papers present comprehensive and substantial research contributions in computational linguistics and natural language processing. These may include novel theoretical models, extensive empirical analyses, or large-scale system designs. Papers in this category typically involve deep and broad exploration, with significant methodological or conceptual innovation. All submissions are held to the highest standards of technical depth, clarity, and impact.

Page Length: Typically up to 40 pages of main text.

Short Papers

Short Papers report focused, high-quality research findings that may offer innovative ideas, efficient methods, or surprising results that advance the field. This track is ideal for compact contributions with strong insights. Well-analyzed negative results or innovative applications are also suitable for this track. Like long papers, short papers are reviewed rigorously and held to the same high standards of scientific and presentation quality.

Page Length: Initial submissions are typically up to 20 pages. Final versions may be up to 25 pages if needed to incorporate revisions or improve clarity.
...
In each issue of the journal we reserve a small number of pages for a personal opinion or provocative perspective on some aspect of the field of computational linguistics. You can see all previous Last Words pieces [here](https://submissions.cljournal.org/index.php/cljournal/Last_Words) . Contact the Editor-in-Chief directly if you are interested in submitting such a piece.
...
- For resubmissions (revise & resubmits), refer to this [checklist](https://submissions.cljournal.org/index.php/cljournal/Resubmissions) .
