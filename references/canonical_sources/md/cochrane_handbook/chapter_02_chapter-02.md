# Cochrane Handbook for Systematic Reviews of Interventions (chapter_02)

Source URL: https://www.cochrane.org/authors/handbooks-and-manuals/handbook/current/chapter-02
Local raw file: `references/canonical_sources/raw/cochrane_handbook/chapter_02_chapter-02.html`
...
A novel review will address a genuine gap in knowledge, so review authors should be aware of any related or overlapping reviews. This reduces duplication of effort, and also ensures that authors understand the wider research context to which their review will contribute. Authors should check for pre-existing syntheses in the published research literature and also for ongoing reviews in the [PROSPERO register of systematic reviews](http://www.crd.york.ac.uk/prospero) before beginning their own review.
