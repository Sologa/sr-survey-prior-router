# Cochrane Handbook for Systematic Reviews of Interventions (chapter_08)

Source URL: https://www.cochrane.org/authors/handbooks-and-manuals/handbook/current/chapter-08
Local raw file: `/Volumes/My Book/NLP_PRISMA_Reviews/docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/raw/cochrane_handbook/chapter_08_chapter-08.html`
...
The full guidance document for the RoB 2 tool is available at [www.riskofbias.info](http://www.riskofbias.info/) : it summarizes the empirical evidence underlying the tool and provides detailed explanations of the concepts covered and guidance on implementation.
...
- the trial was analysed in accordance with a pre-specified plan that was finalized before unblinded outcome data were available for analysis;
...
The specific situations in which a complete case analysis suffers from bias (when there are missing data) are discussed in detail in the full guidance for the RoB 2 tool at [www.riskofbias.info](http://www.riskofbias.info/) . In brief:
