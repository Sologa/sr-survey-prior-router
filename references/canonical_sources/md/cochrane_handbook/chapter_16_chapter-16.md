...
- interventions aimed at the general population, where it is important to understand the distribution of effects across one or more PROGRESS-Plus characteristics;

- interventions focused on disadvantaged or at-risk populations in which there may not be equity outcomes but that may provide evidence about reducing inequities; and

- interventions aimed at reducing social gradients across populations or among subgroups of the population.
...
- the intervention(s) that the review addresses is highly relevant in LMICs and of little or no relevance in high-income countries (HICs);

- there are compelling reasons to believe that the problem or the intervention(s) are different in LMICs;

- the outcomes of interest are different;

- the intervention(s) would be expected to function differently, so that the evidence would be unlikely to be transferrable between LMICs and HICs; or

- the researchers or review commissioners are particularly interested in evidence from LMICs.
...
- present separate tables for populations who experience health inequity to highlight important differences in relative effectiveness;

- create different rows within a single table to highlight differences in baseline risk for specific populations; and

- assess indirectness of evidence for populations that are predefined as important who experience health inequity.
...
- Cochrane and Campbell Equity Checklist for Systematic Review Authors for protocol planning (Ueffing et al 2009);

- PRISMA-Equity Checklist to report findings from equity-focused systematic reviews (Welch et al 2012);

- Sex and gender assessment tool (Doull et al 2010); and

- Sex/gender analysis briefing notes (Doull et al 2014)

For more information see the websites of [the Campbell and Cochrane Equity Methods Group](https://methods.cochrane.org/equity/) , [the Sex/Gender Methods Group](https://methods.cochrane.org/equity/sex-and-gender-analysis) , [Cochrane Child Health](https://childhealth.cochrane.org/) and [Cochrane Global Ageing](https://globalageing.cochrane.org/) .
...
Augustincic Polec L, Petkovic J, Welch V, Ueffing E, Tanjong Ghogomu E, Pardo Pardo J, Grabowsky M, Attaran A, Wells GA, Tugwell P. Strategies to increase the ownership and use of insecticide-treated bednets to prevent malaria. Cochrane Database of Systematic Reviews 2015; 3 : CD009186.
...
EPOC. LMIC Databases: Effective Practice and Organisation of Care; 2013. [https://epoc.cochrane.org/lmic-databases](https://epoc.cochrane.org/lmic-databases) .
...
Hankivsky O. Intersectionality 101 Vancouver (BC): Institute for Intersectionality Research & Policy, Simon Fraser University; 2014.
...
ISSG. The InterTASC Information Specialists' Sub-Group Search Filter Resource 2018. [https://sites.google.com/a/york.ac.uk/issg-search-filters-resource/home](https://sites.google.com/a/york.ac.uk/issg-search-filters-resource/home) .
...
Kugley S, Wade A, Thomas J, Mahood Q, Jørgensen AMK, Hammerstrom K, Sathe N. Searching for studies: a guide to information retrieval for Campbell systematic reviews. Campbell Collboration; 2017. Version 1.1 [https://onlinelibrary.wiley.com/doi/10.4073/cmg.2016.1](https://onlinelibrary.wiley.com/doi/10.4073/cmg.2016.1) .
...
Mackinnon A, Amott N, McGarvey C. Mapping change: Using a theory of change to guide planning and evaluation 2006.
...
Pederson A, Armstrong P. Sex, gender and systematic reviews: the example of wait times for hip and knee replacements. In: Armstrong P, Pederson A, editors. Women’s Health: Intersections of Policy, Research and Practice . Toronto: Women's Press; 2015. p. 56-72.
...
Tugwell P, Petticrew M, Kristjansson E, Welch V, Ueffing E, Waters E, Bonnefoy J, Morgan A, Doohan E, Kelly MP. Assessing equity in systematic reviews: realising the recommendations of the Commission on Social Determinants of Health. BMJ 2010; 341 .

Ueffing E, Tugwell P, Welch V, Petticrew M, Kristjansson E. C1, C2 Equity Checklist for Systematic Review Authors. Version 2009-05-28. 2009.
...
Welch V, Jull J, Petkovic J, Armstrong R, Boyer Y, Cuervo L, Edwards S, Lydiatt A, Gough D, Grimshaw J, Kristjansson E, Mbuagbaw L, McGowan J, Moher D, Pantoja T, Petticrew M, Pottie K, Rader T, Shea B, Taljaard M, Waters E, Weijer C, Wells G, White H, Whitehead M, Tugwell P. Protocol for the development of a CONSORT-equity guideline to improve reporting of health equity in randomized trials. Implementation Science 2015; 10 : 146.
...
Welch VA, Akl EA, Pottie K, Ansari MT, Briel M, Christensen R, Dans A, Dans L, Eslava-Schmalbach J, Guyatt G, Hultcrantz M, Jull J, Katikireddi SV, Lang E, Matovinovic E, Meerpohl JJ, Morton RL, Mosdol A, Murad MH, Petkovic J, Schünemann H, Sharaf R, Shea B, Singh JA, Sola I, Stanev R, Stein A, Thabaneii L, Tonia T, Tristan M, Vitols S, Watine J, Tugwell P. GRADE equity guidelines 3: considering health equity in GRADE guideline development: rating the certainty of synthesized evidence. Journal of Clinical Epidemiology 2017b; 90 : 76-83.

White H. Current challenges in impact evaluation. The European Journal of Development Research 2014; 26 : 18-30.
