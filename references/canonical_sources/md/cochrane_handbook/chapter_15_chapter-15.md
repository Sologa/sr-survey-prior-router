# Cochrane Handbook for Systematic Reviews of Interventions (chapter_15)

Source URL: https://www.cochrane.org/authors/handbooks-and-manuals/handbook/current/chapter-15
Local raw file: `/Volumes/My Book/NLP_PRISMA_Reviews/docs/agent_capability_packs/sr-survey-prior-router/references/canonical_sources/raw/cochrane_handbook/chapter_15_chapter-15.html`

Chapter 15: Interpreting results and drawing conclusions | Cochrane
...
Focus interpretation of results on estimates of effect and their confidence intervals, avoiding use of a distinction between “statistically significant” and “statistically non-significant" . Authors commonly mistake a lack of evidence of effect as evidence of a lack of effect.
...
1b. Re-express and present as units of a familiar measure Presenting data with this approach may be viewed by users as closer to the primary data. However, few instruments are sufficiently used in clinical practice to make many of the presented units easily interpretable. See Section 15.5.3.2 .
...
Note: Re-expressing SMDs is not the only way of expressing results as dichotomous outcomes. For example, the actual outcomes in the studies can be dichotomized, either directly or using assumptions, prior to meta-analysis.
...
Options for presenting information about the outcome post-operative pain and suggested description of the measure
...
Estimated risk or estimated score/value with placebo

Risk difference or relative reduction in score/value with dexamethasone
...
The pain score in the dexamethasone groups was on average 0.79 SDs (1.41 to 0.17) lower than in the placebo groups).
...
The mean post-operative pain scores with placebo was 28.1. 5
...
The pain score in the dexamethasone groups was on average 0.40 (95% CI 0.74 to 0.07) minimal important difference units less than the control group.
...
Comparator group response proportion
0.1
...
Inconsistency Unexplained inconsistency: need for individual participant data meta-analysis; need for studies in relevant subgroups. Studies in patients with small cell lung cancer are needed to understand if the effects differ from those in patients with pancreatic cancer.
