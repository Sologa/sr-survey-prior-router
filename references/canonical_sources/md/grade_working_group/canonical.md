...
- [Members](https://teams.microsoft.com)
...
For more information, see the [GRADE Book](https://book.gradepro.org)

GRADE Vision and Mission

Vision

A world where decisions across all sectors are consistently based on the best available evidence and science, leading to better health outcomes, resilient healthcare systems, and equitable access to effective interventions that account for context and values of the affected populations. The GRADE Working Group envisions its products and methods to be the global benchmark for transparent evidence assessment, empowering individuals, organizations, and policymakers to make informed, values-based decisions.

Mission

To advance evidence-based, contextualized decision-making by providing transparent, rigorous, and accessible methods and tools for grading the certainty of evidence and the strength of health decisions, including recommendations. The GRADE Working Group is committed to improving decision-making by facilitating the interpretation of research findings to inform health guidelines, systematic reviews, health technology assessment, research and health in all policies (e.g., health, education, justice).
...
- Elie Akl, Sue Brennan, Philipp Dahm, Marina Davoli, Monica Hultcrantz, Miranda Langendam, Joerg Meerpohl, Reem Mustafa, Ignacio Neumann, Holger Schünemann, Nicole Skoetz, Jun Xia (members)
...
Clinicians and policy-making users and anyone new to GRADE may want to consider first reading the overview chapter of the [GRADE handbook.](https://book.gradepro.org/guideline/overview-of-the-grade-approach)

### View

Have [Dr. Gordon Guyatt explain GRADE](https://www.youtube.com/watch?v=QEwZPRs8c3g) or watch [introductory lectures by Dr. Holger Schünemann](http://cebgrade.mcmaster.ca) .

### Do

GRADEpro (now also called GRADEpro GDT app) - can be found on the [GRADEpro website](http://gradepro.org/) . GRADEpro and GRADEpro Guideline Development Tool are easy to use all-in-one web solution for summarizing and presenting information for healthcare decision making. It also includes the GRADE handbook. Example evidence profiles can be accessed through the [database of evidence profiles and recommendations.](https://dbep.gradepro.org)

### [GRADE events](https://calendar.google.com/calendar/embed?src=grade.calendar%40gmail.com&ctz=America/New_York)
...
Want to quickly find out what GRADE is all about? We suggest reading our BMJ series. Please note that the online text is the longer, full version of the submitted manuscript. The pdf's on BMJ's website are abbreviated print issues. Start with [GRADE: an emerging consensus on rating quality of evidence and strength of recommendations](http://dx.doi.org/10.1136/bmj.39489.470347.AD) , followed by [What is "quality of evidence" and why is it important to clinicians?](http://dx.doi.org/10.1136/bmj.39490.551019.BE) and [Going from evidence to recommendations](http://dx.doi.org/10.1136/bmj.39493.646875.AE) . You can also learn more about how [diagnostic tests and strategies](http://dx.doi.org/10.1136/bmj.39500.677199.AE) or [resource use](http://dx.doi.org/10.1136/bmj.39504.506319.80) are considered in GRADE.
[Learn more](https://training.cochrane.org/grade-approach)

#### In-depth

The JCE series and the GRADE handbook in [GRADEpro](http://gradepro.org/) provide a guide for systematic review and health technology assessment authors, guideline panelists and methodologists on how to apply the GRADE methodology framework in more detail: [GRADE evidence profiles](http://dx.doi.org/10.1016/j.jclinepi.2010.04.026) , [framing the question and deciding on important outcomes](http://dx.doi.org/10.1016/j.jclinepi.2010.09.012) , [rating the quality of evidence](http://dx.doi.org/10.1016/j.jclinepi.2010.07.015) , [risk of bias](http://dx.doi.org/10.1016/j.jclinepi.2010.07.017) , [publication bias](http://dx.doi.org/10.1016/j.jclinepi.2011.01.011) , [imprecision](http://dx.doi.org/10.1016/j.jclinepi.2011.01.012) , [inconsistency](http://dx.doi.org/10.1016/j.jclinepi.2011.03.017) , [indirectness](http://dx.doi.org/10.1016/j.jclinepi.2011.04.014) , [rating up](http://dx.doi.org/10.1016/j.jclinepi.2011.06.004) , [resource use](http://dx.doi.org/10.1016/j.jclinepi.2012.04.012) , [overall rating](http://dx.doi.org/10.1016/j.jclinepi.2012.01.006) , [Summary of Findings tables (binary)](http://dx.doi.org/10.1016/j.jclinepi.2012.01.012) and [(continues)](http://dx.doi.org/10.1016/j.jclinepi.2012.08.001) , [presentation of recommendations](http://dx.doi.org/10.1016/j.jclinepi.2012.03.013) , and [recommendation's direction and strength](http://dx.doi.org/10.1016/j.jclinepi.2013.02.003) .
[Learn more](https://training.cochrane.org/grade-approach)
...
- Nordic GRADE Network

- Czech GRADE Network

- Italien GRADE Network

- Portuguese GRADE Network

- GRADE Southern Cone Network

- Ireland GRADE Network

### Groups and projects

- [DECIDE research project](http://www.decide-collaboration.eu)
...
- [GRADE-CERQual](http://www.cerqual.org/)
...
#### More than 120 organizations from over 20 countries around the world have endorsed or are using GRADE.
...
# GRADE working group Newsletter Signup

Please sign up to receive news on activities of the GRADE working group

## News

#### Follow us on Facebook and X (formerly Twitter)

New: [GRADE working group newsletter December 2024](https://www.linkedin.com/posts/grade-working-group_grade-newsletter-no-2-december-2024-activity-7275855620572893186-Cpj9/?utm_source=share&utm_medium=member_desktop)
Prior newsletters:
[September 2024](https://www.dropbox.com/scl/fi/7fssqhib5fot53ezsgwc1/GRADE-Working-Group-Newsletter-202409.pdf?rlkey=r0gmeywbqyxx7qocsemff36jo&e=1&dl=0)

###

[GRADEWorkingGroup](https://www.facebook.com/GRADE.WG)

# Get in touch

#### For inquiries, feel free to contact us through your preferred social media channel or through email.

### CONTACT

mail@gradeworkinggroup.org

#### About Us

© 2004-2025 - The GRADE Working Group
...
Do you like cookies? 🍪 We use cookies to ensure you get the best experience on our website. [Learn more](https://cookiesandyou.com/) I agree
