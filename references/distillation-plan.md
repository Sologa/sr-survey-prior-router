...
5. Some sources are script-blocked but now locally captured through manual browser PDFs, including `press` and `cacm_author_guidelines`; `state_of_art_review_2022` was repaired on 2026-05-05 and can now support scoped SotA-review method claims.
